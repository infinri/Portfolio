    ...
    <div class="container">
        <div class="footer-content">
            ...
            <div class="footer-section footer-social">
                ...
                <div class="social-links">
                    ...
                    <a href="https://www.facebook.com/people/Infinri/61585373532873/" target="_blank" rel="noopener" class="social-link">
                        <span class="social-icon-wrapper">
                            <svg class="social-icon" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div class="footer-bottom">
            <div class="footer-bottom-content">
                <p class="footer-copyright">&copy; <?php echo date('Y'); ?> Infinri. All Rights Reserved.</p>
